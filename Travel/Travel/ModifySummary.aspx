...
<body style="background-image:url('Image/On1Call.png'); background-repeat:no-repeat;width: 100%; height: 100%; padding:0px 0px 0px 0px; margin:0px 0px 0px 0px;">
    ...
    <form id="form1" runat="server">
        ...
        <p>
            <br />
            <h1 class="auto-style1"><strong>Modify Request:</strong></h1>
            &nbsp;&nbsp;&nbsp;&nbsp;
        
  <asp:ScriptManager ID="ScriptManager1" runat="server">
            </asp:ScriptManager>            &nbsp;&nbsp;&nbsp;<asp:Label ID="lblTimeRequested" runat="server" Visible="False"></asp:Label>
            <asp:Label ID="lblUser" runat="server" Visible="False"></asp:Label>
            <asp:Label ID="lblFileRef" Visible="false" runat="server"></asp:Label>
            ...
            <asp:Panel ID="Panel1" runat="server" Height="51%" Width="100%">
                ...
                <strong>
                <div class="auto-style1">
                    <asp:Panel ID="Panel4" runat="server" BorderColor="Black" BackColor="Gray" Width="100%">
            ...
            <asp:Panel ID="Panel2" runat="server" Height="48%" Width="100%" CssClass="auto-style11">
                ...
                <asp:Panel ID="Panel7" runat="server">
                    ...
                    <div class="auto-style1">
                        <asp:Panel ID="Panel8" runat="server" BorderColor="Black" BackColor="Gray">
                            <strong>
                            <h3 class="auto-style21"><strong>&nbsp; </strong>REQUESTOR INFORMATION:</h3>
                            <h3><strong>&nbsp; </strong>One Way/Round Trip:
                            ...
                            <h3><strong>&nbsp; </strong>Departing City:
...
&nbsp;
                    ...
                    <asp:FileUpload id="FileUploadControl" runat="server" />
                            ...
                            <asp:Button ID="btnSaved" runat="server"  OnClick="btnSaved_Click" Text="Save" Height="30px" Width="174px" />

                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnBack0" runat="server" Height="30px" OnClick="btnBack_Click" Text="Back" Width="174px" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnCancel" runat="server" Height="30px" OnClick="btnCancel_Click" Text="Cancel" Width="174px" />
