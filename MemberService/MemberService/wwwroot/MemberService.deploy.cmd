...
set _DeploySetParametersFile=%RootPath%MemberService.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MemberService.zip" (
echo "%RootPath%MemberService.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%MemberService.deploy-readme.txt" (
...
start notepad "%RootPath%MemberService.deploy-readme.txt"
)
echo =========================================================
goto :eof
